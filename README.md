...
This repository contains the coreJSON library, a parser that strictly enforces the ECMA-404 JSON standard and is suitable for microcontrollers.  It is distributed under the [MIT License](LICENSE)
